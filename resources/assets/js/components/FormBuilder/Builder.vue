<template>
  <div class="row align-items-start">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="">
                  <div class="accordion-body pt-0">
                    <div class="blocks">
                          ...
                          <li class="list-group-item">
                            <div class="d-flex align-items-center">
                              ...
                              <div class="actions d-flex">
                                ...
                                <div class="btn btn-outline-secondary btn-icon btn-sm configure-input" data-bs-toggle="modal" data-bs-target="#BlockEditorModal" @click="editBlock(index)">
                      ...
                      <button data-bs-toggle="modal" data-bs-target="#kt_modal_1" class="btn btn-light btn-sm w-100 border-gray-500 my-2">
    ...
    <div class="col-8  position-sticky" style="top: 75px;">
    ...
    <!-- Modal-->
    <div class="blocks-modal modal modal-lg fade" tabindex="-1" id="kt_modal_1">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title">New Block</h3>
            <!--begin::Close-->
            <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" aria-label="Close" id="close">
          ...
          <div class="modal-body add_block py-2">
            <template v-for="section in blocks">
            <p class="text-muted fw-bolder my-2">{{section.name}}</p>
            <div class="blocks">
              <button role="button" class="btn btn-light rounded-md p-2 flex flex-col" v-for="block in section.blocks" @click="addBlock(block)">
                <div class="mx-auto py-4">
                  <i :class="block.icon" class="fs-1"></i>
                </div>
                <p class="w-full text-xs text-gray-500 uppercase text-center font-semibold mb-4">{{block.description}}</p>
              </button>
            </div>
            </template>
          </div>
    ...
    <!-- Modal-->
    <!-- Modal-->
    <div class="blocks-modal modal modal-lg fade" tabindex="-1" id="BlockEditorModal">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title" v-if="editedBlock">Edit Block "{{editedBlock.name}}"</h3>

            <div class="actions ms-auto">
              <button class="btn btn-icon btn-sm btn-danger mx-2" @click="removeBlock(editedBlock)"> <i class="fa fa-trash"></i></button>
              <button class="btn btn-icon btn-sm btn-primary mx-2" @click="duplicateBlock(editedBlock)">  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="20" class="h-4 w-4 text-blue-600 inline mr-1 -mt-1"><path d="M5 15H4C3.46957 15 2.96086 14.7893 2.58579 14.4142C2.21071 14.0391 2 13.5304 2 13V4C2 3.46957 2.21071 2.96086 2.58579 2.58579C2.96086 2.21071 3.46957 2 4 2H13C13.5304 2 14.0391 2.21071 14.4142 2.58579C14.7893 2.96086 15 3.46957 15 4V5M11 9H20C21.1046 9 22 9.89543 22 11V20C22 21.1046 21.1046 22 20 22H11C9.89543 22 9 21.1046 9 20V11C9 9.89543 9.89543 9 11 9Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path></svg> </button>
            </div>
            <!--begin::Close-->
            <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal" aria-label="Close" id="close">
              <span class="svg-icon svg-icon-1">
          ...
          <div class="modal-body add_block py-2">
            <BlockEditor v-if="editedBlock" :block.sync="editedBlock"></BlockEditor>
          </div>
...
export default {
  ...
  methods: {
    showBlockModal(){
      this.blocksModalIsVisible = true;
    },
    editBlock(blockIndex){
      this.editedBlock = this.form.properties[blockIndex];
    },
    addBlock(block){
      block = Object.assign({
        width: '100'
      },block.property)
      block.uuid = this.uuid();
      this.form.properties.push(block);

      var modal = bootstrap.Modal.getOrCreateInstance(document.getElementById('kt_modal_1'))
      modal.hide();
    },
    removeBlock(block){
      this.form.properties = this.form.properties.filter((p)=> p.uuid !== block.uuid);
      var modal = bootstrap.Modal.getOrCreateInstance(document.getElementById('BlockEditorModal'))
      modal.hide();
    },
    duplicateBlock(block){
      this.form.properties.push(Object.assign({},block, {
        uuid: this.uuid()
      }));
